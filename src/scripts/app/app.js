...
class App {
  ...
  constructor() {
    //initialize the app immediately the app loads with current user position
    this._getPosition();

    //Display to the UI the local storage data
  ...
  _loadMap(position) {
    ...
    //Only load marker if map has loaded
  ...
  _newWorkout(e) {
    ...
    //5.1. Add a workout to the local storage
